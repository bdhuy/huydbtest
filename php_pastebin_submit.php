...
<html lang="en" ng-app>
  <head>
    ...
    <title>JAV :: PasteBin Submit</title>
    ...
    <div class="container">
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
              <div class="row">
                <div class="col-md-12">
                <form class="form-group" action="php_pastebin_submit.php" method="post" role="form">
                  <div class="row">                      
                        ...
                        <div class="col-md-4">
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control focus" placeholder="input URL" ng-model="input_url" maxlength="60">                      
                          </div>                    
                        </div>
                      <button type="submit" value="submit" name="ok" class="btn btn-sm btn-danger">Submit</button>

                      <div class="col-md-4">
                          <div class="input-group" ng-controller="Main">
                            <span class="input-group-addon"><i class="fa fa-link"></i></span>
                            <input type="text" class="form-control focus" ng-model="input_title" maxlength="60">
                            <script>
                              function Main($scope) {
                                $scope.input_title = '- Xem JAV Online trên YouTube';
                              }
                            </script>
                          </div>                    
                        </div>
                ...
                <textarea class="form-control focus" style="overflow:hidden" name="txt_title">Download JAV {{input_id}} Fshare.vn - Xem JAV Online trên YouTube</textarea>
                <?php
                  ...
                  echo "@h@Download New Hot JAV || {{input_id}} || Luôn Có JAV Mới, Cập Nhật Thường Xuyên !!!\n";
                  echo "@h@Link Fshare.vn:\n";
                  echo "@h@{{input_url}} \n\n";
