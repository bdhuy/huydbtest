            ...
            <div class="panel-body">
                <div class="row no-padding">
                    <div class="col-sm-4 no-padding">
                        ...
                        <div class="input-group no-padding has-warning input-group-sm col-sm-12"><input type="text" class="form-control inselect" id="inputWarning1" name="flashx" ng-model="flashx" placeholder="FlashX Video Link"></div>
                        <div class="input-group no-padding has-warning input-group-sm col-sm-12"><input type="text" class="form-control inselect" id="inputWarning1" name="openload" ng-model="openload" placeholder="OpenLoad.co Video Link"></div>
                    </div>
                    <div class="col-sm-8 no-padding">
                        <div>
                          ...
                          <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation"><a href="#hfx" aria-controls="lxus" role="tab" data-toggle="tab">flashx</a></li>
                          ...
                          <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="F140">
                                <?php 
                                    $str01="";
                                    $str01=$str01."[color=red][b] [url=https://docs.google.com/spreadsheets/d/1vsAlxzm2A9pGEF2N9Sfs2fvFRSV6btnei1KNPtvusVY][color=#490091]JAV Fshare[/color][/url] :: {{phim_title}} :: {{dien_vien}} [/b][/color]\n";                                    
                                    $str01=$str01."\n[color=fuchsia][b]- Link Fshare:[/b][/color] [url]{{fshare_first}}[/url]\n";
                                    $str01=$str01."------------------------------------------------------------------\n";
                                    $str01=$str01.$pr."\n";
                                    $str01=$str01.$fsfolder."\n";
                                ?>
                                <div class="input-group no-padding has-warning input-group-sm col-sm-12"><input type="text" class="form-control inselect" id="inputWarning1" name="phim_title" value="<?php echo 'Download Phim JAV Link Fshare :: {{phim_title}} :: {{dien_vien}}'; ?>"></div>
                                <textarea class="form-control inselect" rows="10"><?php echo $str01; ?></textarea>
                            </div>
                            <div role="tabpanel" class="tab-pane" id="F240">
                                <?php
                                    $str02="";
                                    $str02=$str02."[color=red][b] [url=https://docs.google.com/spreadsheets/d/1vsAlxzm2A9pGEF2N9Sfs2fvFRSV6btnei1KNPtvusVY][color=#490091]JAV Fshare[/color][/url] :: {{phim_title}} :: {{dien_vien}} [/b][/color]\n";                                    
                            ...
                            <div role="tabpanel" class="tab-pane" id="F041">
                                <?php 
                                    $str041="";
                                    $str041=$str041."[color=red][b] [url=https://docs.google.com/spreadsheets/d/1vsAlxzm2A9pGEF2N9Sfs2fvFRSV6btnei1KNPtvusVY][color=#490091]JAV Fshare[/color][/url] :: {{phim_title}} :: {{dien_vien}} [/b][/color]\n";                                    
                                    $str041=$str041."\n[color=fuchsia][b]- Link 4share:[/b][/color] [url]{{fourshare_first}}[/url]\n";
                                    $str041=$str041."------------------------------------------------------------------\n";
                                    $str041=$str041.$pr."\n";
                                    $str041=$str041.$fsfolder."\n";
                                ?>
                                <div class="input-group no-padding has-warning input-group-sm col-sm-12"><input type="text" class="form-control inselect" id="inputWarning1" name="phim_title" value="<?php echo 'Download Phim JAV Link 4Share :: {{phim_title}} :: {{dien_vien}}'; ?>" placeholder="Tựa Phim"></div>
                                <textarea class="form-control inselect" rows="10"><?php echo $str041; ?></textarea>
                            </div>                            
                            <div role="tabpanel" class="tab-pane" id="F141">
                                <?php
                                    $str03="";                                    
                                    $str03=$str03."[color=red][b] [url=https://docs.google.com/spreadsheets/d/1vsAlxzm2A9pGEF2N9Sfs2fvFRSV6btnei1KNPtvusVY][color=#490091]JAV Fshare[/color][/url] :: {{phim_title}} :: {{dien_vien}} [/b][/color]\n";                                    
                                    $str03=$str03."\n[color=fuchsia][b]- Link Fshare:[/b][/color] [url]{{fshare_first}}[/url]\n";
                            ...
                            <div role="tabpanel" class="tab-pane" id="F242">
                                <?php
                                    $str04="";
                                    $str04=$str04."[color=red][b] [url=https://docs.google.com/spreadsheets/d/1vsAlxzm2A9pGEF2N9Sfs2fvFRSV6btnei1KNPtvusVY][color=#490091]JAV Fshare[/color][/url] :: {{phim_title}} :: {{dien_vien}} [/b][/color]\n";                                    
                                    $str04=$str04."\n[color=fuchsia][b]- Link Fshare:[/b][/color]\n";
                            ...
                            ?>
                            <div role="tabpanel" class="tab-pane" id="hfx">
                                <?php
                                    $sh1O0="";
                                    $sh1O0=$sh1O0."";
                                    $sh1O0=$sh1O0."<p style='color:red;font-size:25px; font-weight:bold;margin-bottom:-10px;'><span style='color:blue;'><a href='https://docs.google.com/spreadsheets/d/1vsAlxzm2A9pGEF2N9Sfs2fvFRSV6btnei1KNPtvusVY'>JAV Fshare</a></span>:: <span style='color:red;'>{{phim_title}}</span> :: <span style='color:green;'>{{dien_vien}}</span></p>\n";
                                    $sh1O0=$sh1O0."<p><a href='https://docs.google.com/spreadsheets/d/1vsAlxzm2A9pGEF2N9Sfs2fvFRSV6btnei1KNPtvusVY'><img alt='JAV Fshare' src='{{phim_photo}}' /></a></p>\n";
                                    $sh1O0=$sh1O0."<p style='color:red;font-weight:bold;'>- Xem Phim JAV Online:</p>\n";                                    
                                    $sh1O0=$sh1O0."<iframe src='http://www.flashx.tv/embed-{{flashx}}' frameborder='0' marginwidth='0' marginheight='0' scrolling='no' width='100%' height='300' allowfullscreen='true' webkitallowfullscreen='true' mozallowfullscreen='true'></iframe>\n";
                                ?>
                                <div class="input-group no-padding has-warning input-group-sm col-sm-12"><input type="text" class="form-control inselect" id="inputWarning1" name="phim_title" value="<?php echo 'Xem Phim JAV Free Online :: {{phim_title}} :: {{dien_vien}}'; ?>"></div>
                                <textarea class="form-control inselect" rows="10"><?php echo $sh1O0.$hlink; ?></textarea>
                            </div>
