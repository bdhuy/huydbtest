...
<html lang="en" ng-app>
  ...
  <body>
              ...
              <div class="row">
                ...
                <form class="form-group" action="phim_pastebin_submit.php" method="post" role="form">
                  <div class="row">
                        ...
                        <div class="col-md-6">
                          <textarea class="form-control focus" rows="16" name="pastebin_submit"></textarea>
                        </div>
                        <div class="col-md-6">
                          <textarea class="form-control focus" rows="16" name="javlibs_submit" id="javlibs_submit"></textarea>
    ...
    <script>
      function testfunc(){
        document.getElementById('javlibs_submit').innerHTML='\n\n This is line 01 \n\n';
        document.getElementById('javlibs_submit').innerHTML='\n\n This is line 02 \n\n';
      }
    </script>
